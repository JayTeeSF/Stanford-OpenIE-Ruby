# Ruby wrapper for Stanford OpenIE

The unofficial cross-platform Ruby wrapper for the <b>state-of-art</b> information extraction library from Stanford University.
...
```
git clone https://github.com/jayteesf/Stanford-OpenIE-Ruby.git
cd Stanford-OpenIE-Ruby
echo "Barack Obama was born in Hawaii." > samples.txt
ruby main.rb -f samples.txt
```
...
## Source
This code is a near-transliteration of:
